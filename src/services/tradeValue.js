...
export function buildTradeablePlayers(dynastyRoster, boardPlayers, extraValuesMap = null) {
  ...
  const rosterPlayers = (dynastyRoster || []).map(rp => {
    ...
    return {
      ...
      age: rp.age,
      slot: rp.slot,
      depth_chart_position: rp.depth_chart_position,
      depth_chart_order: rp.depth_chart_order,
      dynasty_value: val,
      has_value: val > 0,
      source: 'roster',
    }
  ...
  const boardOnly = (boardPlayers || [])
    ...
    .map(bp => {
      ...
      return {
        ...
        team: bp.team,
        age: bp.age,
        depth_chart_position: bp.depth_chart_position,
        depth_chart_order: bp.depth_chart_order,
        dynasty_value: val,
        has_value: val > 0,
        source: 'board',
      }
